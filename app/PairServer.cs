...
<section id=""appearance"" hidden><div class=""card""><h2>Appearance</h2><label for=""accent"">Choose your accent</label><input id=""accent"" type=""color"" value=""#E4E4E1""><label for=""background"">Built-in background</label><select id=""background""><option value=""solid"">Plain charcoal</option><option value=""ripple"">Ripple</option><option value=""wave"">Wave</option><option value=""grid"">Mosaic</option><option value=""halo"">Halo</option><option value=""graphite"">Graphite fade</option><option value=""obsidian"">Obsidian</option><option value=""slate"">Slate glow</option><option value=""flowers"">ASCII Flowers</option></select><p>Choose darker gradients or soft accent patterns. No image uploads.</p><div class=""actions""><button class=""save"" id=""saveAppearance"">Save appearance</button><button id=""restoreAppearance"">Restore original charcoal</button></div></div></section><footer>Saved on your PS4. Keep SSPI open and both devices on the same network. Blank key fields keep your saved credentials.</footer></main><script>
